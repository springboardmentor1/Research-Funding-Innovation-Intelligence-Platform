...
const MODULE_PREVIEW = [
  { label: "Funding Opportunity Discovery", status: "Live", tone: "bg-signal-emerald/10 text-signal-emeraldDark" },
  { label: "Application Tracking & Bookmarks", status: "Live", tone: "bg-signal-emerald/10 text-signal-emeraldDark" },
  { label: "Research Trend Intelligence", status: "Milestone 3", tone: "bg-surface-100 text-ink-900/60" },
  { label: "Patent Landscape Analysis", status: "Milestone 3", tone: "bg-surface-100 text-ink-900/60" },
  { label: "Innovation Scoring Engine", status: "Milestone 4", tone: "bg-surface-100 text-ink-900/60" },
];
