...
export default function FundingDiscovery() {
  ...
  return (
    <Layout>
      ...
      {/* Filters */}
      <Card className="mb-6 grid gap-3 sm:grid-cols-2 lg:grid-cols-6">
        <input
          name="q"
      ...
      {!loading && data?.items.length === 0 && <EmptyState message="No funding opportunities match your filters." />}
