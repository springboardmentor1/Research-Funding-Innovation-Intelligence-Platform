...
// Founder, Innovation Manager) can create a profile and sees all four tabs.
// Patent/Technology Intelligence are platform-wide analytics with no
// profile dependency, so every role sees them.
const ALL_TABS = [
