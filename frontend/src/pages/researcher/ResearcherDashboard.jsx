        ...
        <div>
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-blue-400 font-semibold">{info.organization} • {info.domain}</p>
            </div>
          </div>
        </div>
        <div className="flex items-center gap-3">
          <Link
            to="/publications"
            className="px-4 py-2 bg-blue-600 hover:bg-blue-500 text-white rounded-xl text-xs font-bold transition shadow-lg flex items-center gap-2"
          >
            <FaSearch size={12} />
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-5 space-y-2">
          <div className="flex items-center justify-between text-slate-400">
            ...
            <FaBookOpen className="text-blue-400" size={18} />
          </div>
          <p className="text-3xl font-black text-blue-400">{metrics.total_citations?.toLocaleString()}</p>
