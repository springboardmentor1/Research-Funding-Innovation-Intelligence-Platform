  ...
  return (
    <div className="p-6 sm:p-8 bg-slate-950 min-h-screen text-slate-100 selection:bg-amber-500 selection:text-white">
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        {/* Form Container */}
        <form onSubmit={handleSubmit} className="bg-slate-900/30 backdrop-blur-md border border-slate-800/80 rounded-3xl p-6 sm:p-8 space-y-6 shadow-2xl">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-bold uppercase tracking-wider text-slate-300 flex items-center gap-1.5">
                <FaFlask className="text-amber-400" /> Primary Research Domain
              </label>
              <input
                type="text"
                value={domain}
                ...
                className="w-full px-4 py-3 bg-slate-950/70 border border-slate-800 focus:border-amber-500 focus:ring-2 focus:ring-amber-500/20 rounded-xl text-sm text-slate-100 placeholder-slate-600 transition-all outline-none"
                required
              />
            </div>
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-bold uppercase tracking-wider text-slate-300 flex items-center gap-1.5">
                <FaBuilding className="text-yellow-400" /> Institution / Organization
              </label>
              <input
                type="text"
                value={organization}
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-bold uppercase tracking-wider text-slate-300 flex items-center gap-1.5">
                <FaUserTie className="text-amber-400" /> Role Designation
              </label>
              <input
                type="text"
                value={designation}
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-bold uppercase tracking-wider text-slate-300 flex items-center gap-1.5">
                <FaTags className="text-orange-400" /> Research Keywords (Comma Separated)
              </label>
              <textarea
                rows={4}
                value={keywords}
                ...
                className="w-full p-4 bg-slate-950/70 border border-slate-800 focus:border-amber-500 focus:ring-2 focus:ring-amber-500/20 rounded-xl text-sm text-slate-100 placeholder-slate-600 transition-all outline-none resize-none"
              />
            </div>
          ...
          <div className="pt-4 border-t border-slate-900/80">
            <button
              type="submit"
              disabled={saving}
              className="w-full py-3.5 bg-amber-600 hover:bg-amber-500 text-white font-bold rounded-xl text-xs shadow-lg shadow-amber-600/20 transition-all flex items-center justify-center gap-2 disabled:opacity-50"
            >
              {saving ? (
                <>
