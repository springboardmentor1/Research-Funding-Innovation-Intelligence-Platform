        ...
        <div className="lg:col-span-2 bg-slate-900 border border-slate-800 rounded-2xl p-6 space-y-6">
          ...
          <form onSubmit={handleGenerate} className="space-y-5">
              ...
              <div className="grid grid-cols-3 gap-3">
                <button
                  ...
                  className={`p-3 rounded-xl border text-xs font-bold flex items-center justify-center gap-2 transition ${
                    format === 'pdf' ? 'bg-blue-600 border-blue-500 text-white shadow-lg' : 'bg-slate-950 border-slate-800 text-slate-400 hover:border-slate-700'
                  }`}
                >
                  <FaFilePdf size={16} />
            ...
            <button
              type="submit"
              disabled={generating}
              className="w-full py-3.5 bg-blue-600 hover:bg-blue-500 disabled:opacity-50 text-white text-xs font-bold rounded-xl shadow-xl transition flex items-center justify-center gap-2"
            >
              {generating ? (
                <>
                  ...
                  <tr key={idx} className="hover:bg-slate-800/50">
                    ...
                    <td className="py-3 px-4 text-right">
                      <button
                        ...
                        className="px-3 py-1.5 bg-slate-800 hover:bg-slate-700 text-blue-400 font-bold rounded-lg transition inline-flex items-center gap-1.5"
                      >
                        <FaDownload size={11} />
                        <span>Download</span>
                      </button>
