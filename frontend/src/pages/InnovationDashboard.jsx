...
export default function InnovationDashboard() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 p-4 sm:p-6 lg:p-8 selection:bg-blue-500 selection:text-white" data-testid="InnovationDashboard">
      ...
      <div className="max-w-7xl mx-auto mb-8 flex flex-wrap items-center justify-between gap-4 border-b border-slate-800 pb-5">
        ...
        <div className="flex items-center gap-3">
          ...
          >
            <FiRefreshCw className={`w-4 h-4 ${loading ? 'animate-spin text-blue-400' : ''}`} />
          </button>
          <button
