    ...
    <aside className="w-64 bg-[#141b2d] h-screen border-r border-slate-800 flex flex-col fixed left-0 top-0">
      ...
      <div className="h-16 flex items-center px-6 border-b border-slate-800">
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 rounded-full bg-blue-500 flex items-center justify-center shadow-[0_0_15px_rgba(59,130,246,0.5)]"></div>
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              `flex items-center gap-4 px-4 py-3 rounded-lg transition-colors font-medium text-sm ${
                isActive
                  ? 'text-white bg-slate-800/50 relative before:absolute before:left-0 before:top-2 before:bottom-2 before:w-1 before:bg-blue-500 before:rounded-r-md'
