...
export default function OpportunityDetail() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-surface-50">
        <Navbar />
        <div className="mx-auto max-w-3xl px-6 py-16 text-center text-sm text-ink-900/50">Loading…</div>
      </div>
    );
  }
  ...
  if (!opportunity) {
    return (
      <div className="min-h-screen bg-surface-50">
        <Navbar />
        <div className="mx-auto max-w-3xl px-6 py-16 text-center text-sm text-signal-rose">{error || "Not found."}</div>
      </div>
    );
  }
