...
### Milestones 1 & 2 — Core Setup + Funding Opportunity Management, Applications, Bookmarks & Notifications
...
system, an admin analytics dashboard, and file uploads — built with Clean
Architecture (repository-service pattern).

> **Scope note:** This repository implements **Milestones 1 and 2**. Research
> Trend Intelligence, Patent Landscape Analysis, Technology Intelligence, the
> Innovation Scoring Engine, and Commercialization Recommendations
> (Milestones 3–4) are intentionally out of scope here.
...
- **Milestone 3:** Research Trend Intelligence, Patent Landscape Analysis,
  Technology Intelligence
- **Milestone 4:** Innovation Scoring Engine, Commercialization
  Recommendations, executive dashboards, security & performance testing,
